...
|mark|true, false|false|A run of content that is marked or highlighted, such as for reference purposes, or to call it out as having a special purpose that is clear from context. This is similar to IA2_ROLE_MARK, but this is used where it may apply to a partial span of text in an object, rather than to an entire object.| |
